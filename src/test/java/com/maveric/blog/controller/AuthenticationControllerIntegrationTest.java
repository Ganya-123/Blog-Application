...
class AuthenticationControllerIntegrationTest {
    ...
    void testRegister_Success() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/auth/register")
                        ...
                        .content("{\"fullName\":\"John Doe\",\"email\":\"john.doe@example.com\",\"password\":\"password123\",\"role\":\"WRITE\",\"bio\":\"Hello, I'm John\",\"avatar\":\"ALIEN\",\"mobileNumber\":\"1234567890\"}"))
    ...
    void testForgotPassword_Success() throws Exception {
        when(authenticationService.forgotPassword(any(ForgotPassword.class))).thenReturn(Constants.PASSWORD_RESET_SUCCESS);

        mockMvc.perform(put("/api/v1/auth/forgotPassword")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("{\"emailId\":\"john.doe@example.com\",\"mobileNumber\":\"1234567890\",\"newPassword\":\"newpassword123\",\"confirmPassword\":\"newpassword123\"}"))
                .andExpect(status().isOk())
    ...
    void testForgotPassword_MobileNumberMismatch() throws Exception {
        ...
        mockMvc.perform(put("/api/v1/auth/forgotPassword")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("{\"emailId\":\"john.doe@example.com\",\"mobileNumber\":\"wrong_mobile_number\",\"newPassword\":\"newpassword123\",\"confirmPassword\":\"newpassword123\"}"))
                .andExpect(status().isOk())
    ...
    void testForgotPassword_NewPasswordMismatch() throws Exception {
        ...
        mockMvc.perform(put("/api/v1/auth/forgotPassword")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("{\"emailId\":\"john.doe@example.com\",\"mobileNumber\":\"1234567890\",\"newPassword\":\"newpassword123\",\"confirmPassword\":\"differentpassword\"}"))
                .andExpect(status().isOk())
                .andExpect(content().string(errorMessage));
    }
    ...
    void testForgotPassword_SameAsCurrentPassword() throws Exception {
        ...
        mockMvc.perform(put("/api/v1/auth/forgotPassword")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("{\"emailId\":\"john.doe@example.com\",\"mobileNumber\":\"1234567890\",\"newPassword\":\"password123\",\"confirmPassword\":\"password123\"}"))
                .andExpect(status().isOk())
                .andExpect(content().string(errorMessage));
    }
}

            ...
            content()
                .json(
                    "{\"status\":\"BAD_REQUEST\",\"message\":\""
                        + Constants.AUTHOR_VALIDATION_FAILED
                        + "\",\"errors\":[]}")); // Validate the message here
  }

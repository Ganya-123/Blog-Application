...
class UserControllerTest {
    ...
    void testChangePassword_AuthorizationFailed() {
        ...
        Exception exception = assertThrows(AuthorValidationException.class, () -> {
            userController.changePassword(changePassword, token);
        });
    ...
    void testUpdateUser_Success() {
        ...
        ResponseEntity<RegisterResponse> response = userController.updateUser(1L, updateRequest, "Bearer valid_token");

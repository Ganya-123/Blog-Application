...
public class PostControllerIntegrationTesting {
    ...
    public void testCreatePost() throws Exception {
        ...
        when(postService.createPost(any(PostRequestDto.class), anyString())).thenReturn(postResponseDto);
    ...
    void testPublishPost_Success() throws Exception {
        ...
        mockMvc.perform(put("/author/{authorId}/post/{postId}/publish", 1L, 1L)
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void testPublishPost_AuthorValidationFailed() throws Exception {
        ...
        mockMvc.perform(put("/author/{authorId}/post/{postId}/publish", 1L, 2L)
                        .contentType(MediaType.APPLICATION_JSON)
                        .header("Authorization", VALID_TEST_TOKEN))
    ...
    void testUnpublishPost_Success() throws Exception {
        ...
        mockMvc.perform(put("/author/{authorId}/post/{postId}/unpublish", 1L, 1L)
                        .contentType(MediaType.APPLICATION_JSON)
                        .header("Authorization", VALID_TEST_TOKEN))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.postId").value(postResponseDto.getPostId()))
    ...
    void testUnpublishPost_AuthorValidationFailed() throws Exception {
        ...
        mockMvc.perform(put("/author/{authorId}/post/{postId}/unpublish", 1L, 2L)
                        .contentType(MediaType.APPLICATION_JSON)
                        .header("Authorization", VALID_TEST_TOKEN))
                .andExpect(jsonPath("$.message").value(Constants.AUTHOR_VALIDATION_FAILED))
                .andExpect(jsonPath("$.errors").isEmpty());
    ...
    void testDeletePost_Success() throws Exception {
        ...
        mockMvc.perform(delete("/author/{authorId}/post/{postId}", 1L, 2L)
                        .header("Authorization", VALID_TEST_TOKEN))
                .andExpect(status().isOk())
    ...
    void testDeletePost_AuthorValidationFailed() throws Exception {
        when(postService.deletePost(anyLong(), anyLong(), anyString())).thenThrow(new AuthorValidationException(Constants.AUTHOR_VALIDATION_FAILED));
    ...
    void testDeletePost_PostNotFound() throws Exception {
        when(postService.deletePost(anyLong(), anyLong(), anyString())).thenThrow(new PostNotFoundException(Constants.POST_NOT_FOUND));
    ...
    void testDeletePost_AuthorIsDifferent() throws Exception {
        when(postService.deletePost(anyLong(), anyLong(), anyString())).thenThrow(new AuthorValidationException(Constants.AUTHOR_IS_DIFFERENT));
    ...
    void testAdminDeletePost_Success() throws Exception {
        ...
        mockMvc.perform(delete("/{postId}", 1L)
                        .header("Authorization", VALID_TEST_TOKEN))
                .andExpect(content().string(responseMessage));
    ...
    void testAdminDeletePost_PostNotFound() throws Exception {
        when(postService.adminDeletePost(anyLong())).thenThrow(new PostNotFoundException(Constants.POST_NOT_FOUND));

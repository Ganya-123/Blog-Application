...
class CommentControllerTest {
  ...
  void testEditComment_Success() {
    ...
    verify(commentService, times(1))
        .editComment(anyLong(), any(CommentRequestDto.class), anyString());
  }
  ...
  void testDeleteComment_AuthorValidationFailed() {
    ...
    AuthorValidationException exception =
        assertThrows(
            AuthorValidationException.class, () -> commentController.deleteComment(1L, 1L, token));
  ...
  void testDeleteComment_CommentNotFound() {
    ...
    CommentNotFoundException exception =
        assertThrows(
            CommentNotFoundException.class, () -> commentController.deleteComment(1L, 1L, token));
  }
  ...
  void testAdminDelete_CommentNotFound() {
    ...
    CommentNotFoundException exception =
        assertThrows(CommentNotFoundException.class, () -> commentController.adminDelete(1L));

...
public class CommentServiceTest {
  ...
  void testCreateComment_AuthorValidationFailed() {
    ...
    AuthorValidationException exception =
        assertThrows(
            AuthorValidationException.class, () -> commentService.createComment(requestDto, token));
  ...
  void testCreateComment_UserNotFound() {
    ...
    assertThrows(
        UserNotFoundException.class, () -> commentService.createComment(requestDto, token));
  }
  ...
  void testCreateComment_PostNotFound() {
    ...
    assertThrows(
        PostNotFoundException.class, () -> commentService.createComment(requestDto, token));
  }
  ...
  void testCreateComment_PostNotPublished() {
    ...
    PublishPostException exception =
        assertThrows(
            PublishPostException.class, () -> commentService.createComment(requestDto, token));
  ...
  void testCreateComment_ParentCommentNotFound() {
    ...
    assertThrows(
        CommentNotFoundException.class, () -> commentService.createComment(requestDto, token));
  }
  ...
  void testEditComment_CommentNotFound() {
    ...
    assertThrows(
        CommentNotFoundException.class, () -> commentService.editComment(1L, requestDto, token));
  }
  ...
  void testDeleteComment_AuthorValidationFailed() {
    ...
    AuthorValidationException exception =
        assertThrows(
            AuthorValidationException.class, () -> commentService.deleteComment(1L, 1L, token));
  ...
  void testDeleteComment_CommentNotFound() {
    ...
    assertThrows(CommentNotFoundException.class, () -> commentService.deleteComment(1L, 1L, token));
  }
  ...
  void testAdminDelete_CommentNotFound() {
    ...
    CommentNotFoundException exception =
        assertThrows(CommentNotFoundException.class, () -> commentService.adminDelete(1L));

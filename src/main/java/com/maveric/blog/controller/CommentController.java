...
public class CommentController {
    ...
    public ResponseEntity<CommentResponseDto> createComment(@Valid @RequestBody CommentRequestDto requestDto, @RequestHeader("Authorization") String token) {
    ...
    public ResponseEntity<CommentResponseDto> editComment(
            ...
            @Valid @RequestBody CommentRequestDto requestDto, @RequestHeader("Authorization") String token) {
    ...
    @PreAuthorize("hasAuthority('WRITE')")
    public ResponseEntity<String> deleteComment(@PathVariable Long commentId, @PathVariable Long authorId, @Valid @RequestHeader("Authorization") String token) {

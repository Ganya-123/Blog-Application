...
public class AuthenticationService {
    ...
    public String changePassword(ChangePassword changePassword, String token) {
        Long tokenUserId = jwtService.extractUserId(token.substring(7));

        User user = userRepository.findByEmail(changePassword.getEmailId())
    ...
    public String forgotPassword(ForgotPassword forgotPassword) {
        ...
        User user = userRepository.findByEmail(forgotPassword.getEmailId())
                .orElseThrow(() -> new UserNotFoundException(Constants.AUTHOR_NOT_FOUND));

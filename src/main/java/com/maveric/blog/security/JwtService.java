...
public class JwtService {
    ...
    private static final String SECRET_KEY = "467637674e4b277a5d526f485e75712742426b71314b496a5d6265457e";
    ...
    public boolean isTokenValid(String token, UserDetails userDetails) {
        ...
        return username.equals(userDetails.getUsername()) && !isTokenExpired(token) && !jwtTokenService.isTokenInvalid(token);
    }
